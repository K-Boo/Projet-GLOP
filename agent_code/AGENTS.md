...
## 2. Structure des Dossiers de Code
...
## 3. Standards de Code & Bonnes Pratiques
...
* **Interdiction des emojis** : Aucun emoji dans la documentation technique, les fichiers Markdown, les commentaires de code et les messages de commit Git.
